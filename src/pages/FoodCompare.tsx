      ...
      <main className="pt-24 pb-16 px-4 sm:px-6">
        <div className="max-w-5xl mx-auto">
          <div className="mb-8">
            ...
            <h1 className="text-3xl font-medium text-wellness-darkGreen mt-4 mb-2">Food Comparison</h1>
            <p className="text-wellness-charcoal">Compare nutritional values between different foods to make better dietary choices.</p>
          </div>
